...
namespace hotel_system.Model.Context
{
    public class DbContext : IDisposable
    {
        ...
        private MySqlConnection GetOpenConnection()
        {
            ...
            try // penggunaan blok try-catch untuk penanganan error
            {
                ...
                string myConnectionString = "server=127.0.0.1;uid=root;pwd=;database=hotel";
                // deklarasi variabel connectionString, ref: https://www.connectionstrings.com/
                //string connectionString = string.Format("Data Source={0};FailIfMissing=True", dbName);
                conn = new MySqlConnection(myConnectionString); // buat objek connection
